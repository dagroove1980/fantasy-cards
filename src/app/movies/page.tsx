...
export const metadata = {
  title: 'Fantasy Movies — Browse 100+ Fantasy Films',
  description:
    'Discover the best fantasy movies of all time. Filter by genre, rating, and decade. From epic adventures to dark fantasy, find your next favorite film. Updated with new releases.',
  openGraph: {
    title: 'Fantasy Movies | Fantasy Cards',
    description: 'Browse 100+ fantasy films. Filter by genre, rating, decade. Epic adventures, dark fantasy, and more.',
    url: `${SITE_URL}/movies`,
  },
};
    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      <header className="mb-8">
        ...
        <p className="text-secondary mt-2 max-w-2xl">
          Our curated collection of over 100 fantasy films. From Lord of the Rings to Avatar, 
